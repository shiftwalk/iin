        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div className="col-span-1 aspect-square bg-[#5F0EFF] flex items-center justify-center relative">
            <div className="absolute inset-0 flex justify-center items-center pointer-events-none z-0">
              <div className="w-[50%] h-[75%] bg-off-black bg-opacity-[7.5%]"></div>
            </div>

            <div className="w-10/12 text-center text-white max-w-[500px] md:max-w-[400px] relative z-10">
              ...
              <p className="mb-12">Amazing food and drinks, all the shops you&apos;ll ever need, and inspirational events and activities.</p>
          ...
          <div className="col-span-1 aspect-square bg-[#EFF366] flex items-center justify-center">
            <div className="w-10/12 text-center text-off-black max-w-[500px] md:max-w-[400px]">
              ...
              <p className="mb-12">No spam, ever. Just occasional news, city updates, and tasty offers direct to your inbox!</p>

              <form className="relative">
                <input type="email" placeholder="Your email address..." className="appearance-none rounded-full bg-white py-4 px-6 inline-block leading-none w-full a11y-focus focus-visible:ring-2" />
